      ...
      <div class="row">
        <div class="col-md-5 ml-auto">
          <div class="detail-box">
            ...
            <p>
              Почему стоит обратиться именно к нам?<br>
              Потому что у нас лучшие цены на разные виды тренировок, вы можете выбрать личные тренировки которые хотите и мы подберем вам лучших тренеров.
            </p>
            <a href="product.php">
